...
/**
 * Catches all pages that are not defined in the `pages` directory,
 *   and renders Plasmic pages at the matching route.
 * To implement your own index.tsx page, rename this file to [...catchall].tsx.
 */
